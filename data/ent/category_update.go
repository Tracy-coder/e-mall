...
func (cu *CategoryUpdate) AddProductIDs(ids ...uint64) *CategoryUpdate {
...
func (cu *CategoryUpdate) RemoveProductIDs(ids ...uint64) *CategoryUpdate {
...
// AddProductIDs adds the "product" edge to the Product entity by IDs.
func (cuo *CategoryUpdateOne) AddProductIDs(ids ...uint64) *CategoryUpdateOne {
...
// RemoveProductIDs removes the "product" edge to Product entities by IDs.
func (cuo *CategoryUpdateOne) RemoveProductIDs(ids ...uint64) *CategoryUpdateOne {
