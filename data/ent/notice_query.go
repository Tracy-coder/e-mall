...
func (nq *NoticeQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (nq *NoticeQuery) FirstIDX(ctx context.Context) uint64 {
...
func (nq *NoticeQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (nq *NoticeQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (nq *NoticeQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (nq *NoticeQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := nq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (nq *NoticeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(notice.Table, notice.Columns, sqlgraph.NewFieldSpec(notice.FieldID, field.TypeUint64))
	_spec.From = nq.sql
