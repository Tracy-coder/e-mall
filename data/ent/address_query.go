...
func (aq *AddressQuery) QueryUserAddress() *UserQuery {
...
func (aq *AddressQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (aq *AddressQuery) FirstIDX(ctx context.Context) uint64 {
...
func (aq *AddressQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (aq *AddressQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (aq *AddressQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (aq *AddressQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AddressQuery) WithUserAddress(opts ...func(*UserQuery)) *AddressQuery {
	query := (&UserClient{config: aq.config}).Query()
...
func (aq *AddressQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Address, error) {
	...
	if query := aq.withUserAddress; query != nil {
		if err := aq.loadUserAddress(ctx, query, nodes, nil,
			func(n *Address, e *User) { n.Edges.UserAddress = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (aq *AddressQuery) loadUserAddress(ctx context.Context, query *UserQuery, nodes []*Address, init func(*Address), assign func(*Address, *User)) error {
